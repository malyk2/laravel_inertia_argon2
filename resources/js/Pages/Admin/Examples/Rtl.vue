...
<script>
import Card from "@/Views/Examples/Admin/Cards/Card.vue";
import DeveloperCard from "@/Views/Examples/Admin/DeveloperCard.vue";
import RocketCard from "@/Views/Examples/Admin/RocketCard.vue";
import ActiveUsersChart from "@/Views/Examples/Admin/Charts/ActiveUsersChart.vue";
...
export default {
  ...
  beforeMount() {
    this.$store.state.theme.isRTL = true;
    document.querySelector("html").setAttribute("lang", "ar");
    document.querySelector("html").setAttribute("dir", "rtl");
    document.querySelector("#app").classList.add("rtl");
  },
  beforeUnmount() {
    this.$store.state.theme.isRTL = false;
