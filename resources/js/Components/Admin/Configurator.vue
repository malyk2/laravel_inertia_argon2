  ...
  <div class="fixed-plugin">
    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div
          class=""
          :class="this.$store.state.theme.isRTL ? 'float-end' : 'float-start'"
        >
        ...
        <div
          class="mt-4"
          @click="toggle"
          :class="this.$store.state.theme.isRTL ? 'float-start' : 'float-end'"
        >
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <a href="#" class="switch-trigger background-color">
          <div
            ...
            :class="this.$store.state.theme.isRTL ? 'text-end' : ' text-start'"
          >
            <span
        ...
        <div class="d-flex gap-2">
          <button
            ...
            :class="
              this.$store.state.theme.sidebarType === 'bg-white'
                ? 'bg-gradient-success'
                : 'btn-outline-success'
            "
        ...
        <div class="mt-3 d-flex">
          ...
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input
              ...
              :class="
                this.$store.state.theme.isRTL ? 'float-end  me-auto' : ' ms-auto'
              "
              type="checkbox"
              id="navbarFixed"
              :checked="this.$store.state.theme.isNavFixed"
        ...
        <div class="mt-2 mb-5 d-flex">
          <h6 class="mb-0" :class="this.$store.state.theme.isRTL ? 'ms-2' : ''">
            Light / Dark
          </h6>
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input
              ...
              type="checkbox"
              :checked="this.$store.state.theme.darkMode"
              @click="setDarkMode"
            />
          </div>
        </div>
...
export default {
  ...
  props: ["toggle"],
  methods: {
    ...mapMutations('theme', ["navbarMinimize", "sidebarType", "navbarFixed"]),
    ...mapActions('theme', ["setSidebarColor"]),
    sidebarColor(color = "success") {
      console.log('sidebarColor')
      console.log(color)
      // document.querySelector("#sidenav-main").setAttribute("data-color", color);
      // this.$store.state.theme.mcolor = `card-background-mask-${color}`;
      this.setSidebarColor(color)
    },
    sidebarType(type) {
      this.$store.state.theme.sidebarType = type;
    },
    setNavbarFixed() {
      // if (
      ...
      // ) {
        this.$store.state.theme.isNavFixed = !this.$store.state.theme.isNavFixed;
      // }
    },
    setDarkMode() {
